...
- Full versions of the activities discussed in Section \ref{sec:intro} along with instructor guides. Further activities will be hosted at <BLINDED URL> in the future.

- A tutorial on using nullabor and ggplot2 to create lineups for common topics in introductory statistics can be found at <BLINDED URL>.

- A suite of Shiny apps that creates lineups for common topics in introductory statistics can be found at <BLINDED URL>
