...
# well_glm2 <- glm(switch ~ arsenic + I(arsenic^2), family = binomial, data = wells)
# sim_response <- simulate(well_glm2)[[1]]

# wells[["switch"]] <- sim_response
...
well_lineup[[20]] <- data.frame(sim_1 = simulate(well_glm2)[[1]])
