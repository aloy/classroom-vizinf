...
- Live Shiny apps
  + [Detecting association: Two categorical variables](http://shinyapps.carleton.edu/multi-sample-cat-app)
  + [Detecting association: Quantitative vs. categorical](http://shinyapps.carleton.edu/multi-sample-quant-app)
  + [Exploring residual plots in SLR](http://shinyapps.carleton.edu/lm-resids-app)
  + [Interpreting Q-Q plots](http://shinyapps.carleton.edu/qqplots)
